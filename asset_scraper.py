...
# TODO: Update this scraper so it prints a separate
...
def get_projects_from_team(client, team):
    ...
    for proj in data:
        # Add project_name and team_name to the dict, we'll print them in our .csv
...
def scrape_asset_data_from_projects(client, projects):
    """
    Scrapes the asset data for a provided client and projects.
    ...
    for project in projects:
        ...
        for asset in assets_in_project:
            # TODO: Repeats code from L35-36 and really shouldn't
...
def scrape_asset_data(client, asset_id, asset_list):
    ...
    for asset in assets:
        ...
        if asset['type'] == "folder" and asset != []:
            # In this example we'll include non-empty folders in the list of scraped assets
